...
--
-- Хост: localhost
-- Время создания: Мар 04 2025 г., 23:21
...
(22, 'Ильдар', 'ildar@email.com', '$2y$10$xcQsx1bGR2AlYMCMP9cONednyCRlvzmMZ6Twlt9KaaJdVTKk4yTbW');
...
--
ALTER TABLE `tickets`
  MODIFY `ticket_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
