...
--
-- Хост: localhost
-- Время создания: Мар 09 2025 г., 17:13
...
(11, 3, 3, '2025-03-04 23:07:44', 111),
(12, 3, 4, '2025-03-04 23:07:44', 121);
...
(2, 5, 2, '12', '2025-03-12 15:00:01'),
(3, 5, 2, '12', '2025-03-12 15:00:01'),
(4, 8, 7, '100, 8', '2025-03-09 13:58:42'),
(5, 8, 7, '12', '2025-03-12 15:00:01'),
(6, 7, 7, '1', '2025-03-09 15:09:35');
...
(1, 'admin', 'admin@admin.adm', '$2y$10$fs.QgSjFCJ2zeVfRQAnqn.Fipjp4du.mS4XWu1fHGKTXnFm8pJd46', 'admin'),
(2, 'NameFromAdmin', 'email@from.admin', 'password', 'user'),
(3, 'IsName', 'ddd', '$2y$10$CG5H9ImSZ89PkHFzJmkFpO1FHbOLlZaUOQbntC7y8Ck9VMug1LNNK', 'user'),
(4, 'Ildar', 'ildar@email.com', '$2y$10$jik3axBAKOJDMDPi9EO6.O5m63ozGnrQcMYEMqNXddPfDT5pvooA2', 'user'),
(7, 'Ильдар', 'ildarmyname@gmail.com', '$2y$10$7yfGDtZdWjfVdjzIz4EfGO.HZKqrCqIgKYMCGNTzCGCaBJfV/HQZG', 'admin'),
(9, 'Ильдар', 'ildarmyname@gmail.com1', '$2y$10$Uy7mAZNGvygpQBAO9C0Ky.2zLKa6mqK8ftC.ssg2wCI4h1j.pn96C', 'user');
...
CREATE TABLE `users_phone` (
  `id` int NOT NULL,
  `user_id` int NOT NULL,
  `phone1` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT '',
  `phone2` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT '',
  `phone3` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `users_phone` (`id`, `user_id`, `phone1`, `phone2`, `phone3`) VALUES
(1, 1, '87781193946', '81112223344', '85556667788'),
(8, 7, '87781193946', '87771113344', ''),
(11, 9, '87781193946', '87771113344', NULL);
...
--
ALTER TABLE `cinemas`
  MODIFY `cinema_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT для таблицы `halls`
--
ALTER TABLE `halls`
  MODIFY `hall_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `screenings`
  MODIFY `screening_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
